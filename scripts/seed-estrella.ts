...
const KANBAN_CATEGORIES = [
    { name: "Vertrieb", identifier: "ufficio", color: "#F59E0B", icon: "BadgeDollarSign", display_order: 0, is_internal: false, internal_base_code: null as number | null },
    { name: "Technisches Büro", identifier: "ufficio-tecnico", color: "#6B7280", icon: "Mouse", display_order: 1, is_internal: false, internal_base_code: null },
    { name: "Produktion", identifier: "produzione", color: "#EC4899", icon: "Factory", display_order: 2, is_internal: false, internal_base_code: null },
    { name: "Service", identifier: "service", color: "#3B82F6", icon: "Drill", display_order: 3, is_internal: true, internal_base_code: 7000 },
    { name: "Fakturierung", identifier: "fatturazione", color: "#10B981", icon: "ArrowRightFromLine", display_order: 4, is_internal: false, internal_base_code: null },
    { name: "Intern", identifier: "interni", color: "#3B82F6", icon: "Home", display_order: 5, is_internal: true, internal_base_code: 1000 },
];
...
const KANBAN_BOARDS: KanbanDef[] = [
    {
        ...
        columns: [
            { title: "Zu erledigen", identifier: "to_do_0_offerte", position: 1, column_type: "normal", is_creation_column: false },
            { title: "Bearbeitung", identifier: "elaborazione_0_offerte", position: 2, column_type: "normal", is_creation_column: true },
            { title: "Gesendet", identifier: "inviata_0_offerte", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Verhandlung", identifier: "trattativa_0_offerte", position: 4, column_type: "normal", is_creation_column: false },
            { title: "Gewonnen", identifier: "vinta_0_offerte", position: 5, column_type: "won", is_creation_column: false },
            { title: "Verloren", identifier: "persa_0_offerte", position: 6, column_type: "lost", is_creation_column: false },
        ],
    },
    {
        title: "AVOR",
        ...
        columns: [
            { title: "Zu erledigen", identifier: "to_do_1_avor", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Aufmass", identifier: "rilievo_1_avor", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Bearbeitung", identifier: "elaborazione_1_avor", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Produktion", identifier: "produzione_1_avor", position: 4, column_type: "production", is_creation_column: false },
        ],
    },
    {
        title: "1. Emaillierte Apparate",
        ...
        columns: [
            { title: "Zu erledigen", identifier: "to_do_apparecchi", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Fertigung", identifier: "fabbricazione_apparecchi", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Schweissen", identifier: "saldatura_apparecchi", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Sandstrahlen", identifier: "sabbiatura_apparecchi", position: 4, column_type: "normal", is_creation_column: false },
            { title: "Emaillierung", identifier: "smaltatura_apparecchi", position: 5, column_type: "normal", is_creation_column: false },
            { title: "Brennen", identifier: "cottura_apparecchi", position: 6, column_type: "normal", is_creation_column: false },
            { title: "Abnahme", identifier: "collaudo_apparecchi", position: 7, column_type: "normal", is_creation_column: false },
            { title: "Versendet", identifier: "spedito_apparecchi", position: 8, column_type: "invoicing", is_creation_column: false },
        ],
    },
    {
        title: "2. Kolonnen",
        ...
        is_production_kanban: true,
        columns: [
            { title: "Zu erledigen", identifier: "to_do_colonne", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Fertigung", identifier: "fabbricazione_colonne", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Schweissen", identifier: "saldatura_colonne", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Emaillierung", identifier: "smaltatura_colonne", position: 4, column_type: "normal", is_creation_column: false },
            { title: "Brennen", identifier: "cottura_colonne", position: 5, column_type: "normal", is_creation_column: false },
            { title: "Abnahme", identifier: "collaudo_colonne", position: 6, column_type: "normal", is_creation_column: false },
            { title: "Versendet", identifier: "spedito_colonne", position: 7, column_type: "invoicing", is_creation_column: false },
        ],
    },
    {
        title: "3. Rohrleitungsteile",
        ...
        is_production_kanban: true,
        columns: [
            { title: "Zu erledigen", identifier: "to_do_tubazioni", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Zuschnitt", identifier: "taglio_tubazioni", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Schweissen", identifier: "saldatura_tubazioni", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Emaillierung", identifier: "smaltatura_tubazioni", position: 4, column_type: "normal", is_creation_column: false },
            { title: "Abnahme", identifier: "collaudo_tubazioni", position: 5, column_type: "normal", is_creation_column: false },
            { title: "Versendet", identifier: "spedito_tubazioni", position: 6, column_type: "invoicing", is_creation_column: false },
        ],
    },
    {
        title: "4. Tantal-Wärmetauscher",
        ...
        is_production_kanban: true,
        columns: [
            { title: "Zu erledigen", identifier: "to_do_scambiatori", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Fertigung", identifier: "fabbricazione_scambiatori", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Tantal-Schweissen", identifier: "saldatura_scambiatori", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Montage", identifier: "assemblaggio_scambiatori", position: 4, column_type: "normal", is_creation_column: false },
            { title: "ZfP / Prüfung", identifier: "controllo_scambiatori", position: 5, column_type: "normal", is_creation_column: false },
            { title: "Versendet", identifier: "spedito_scambiatori", position: 6, column_type: "invoicing", is_creation_column: false },
        ],
    },
    {
        title: "5. Tantal-Heizelemente",
        identifier: "elementi",
        categoryIdentifier: "produzione",
        color: "#a03784",
        icon: "Zap",
        is_production_kanban: true,
        columns: [
            { title: "Zu erledigen", identifier: "to_do_elementi", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Bearbeitung", identifier: "lavorazione_elementi", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Montage", identifier: "assemblaggio_elementi", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Prüfung", identifier: "controllo_elementi", position: 4, column_type: "normal", is_creation_column: false },
            { title: "Versendet", identifier: "spedito_elementi", position: 5, column_type: "invoicing", is_creation_column: false },
        ],
    },
    {
        title: "Service",
        ...
        icon: "Settings",
        columns: [
            { title: "Zu erledigen", identifier: "to_do_service", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Geplant", identifier: "pianificato_service", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Ausführung", identifier: "esecuzione_service", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Abgeschlossen", identifier: "ultimato_service", position: 4, column_type: "normal", is_creation_column: false },
        ],
    },
    {
        ...
        columns: [
            ...
            { title: "Bezahlt", identifier: "pagata_fatture", position: 3, column_type: "normal", is_creation_column: false },
        ],
    },
    {
        title: "Diverses",
        ...
        icon: "Network",
        columns: [
            { title: "Zu erledigen", identifier: "to_do_diversi", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Konstruktion", identifier: "progettazione_diversi", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Ausführung", identifier: "esecuzione_diversi", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Abgeschlossen", identifier: "ultimato_diversi", position: 4, column_type: "normal", is_creation_column: false },
        ],
    },
    {
        title: "F&E",
        ...
        icon: "Rocket",
        columns: [
            { title: "Zu erledigen", identifier: "to_do_9_rd", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Konstruktion", identifier: "progettazione_9_rd", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Prototyp", identifier: "prototipo_9_rd", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Abnahme", identifier: "collaudo_9_rd", position: 4, column_type: "normal", is_creation_column: false },
            { title: "Abgeschlossen", identifier: "ultimato_9_rd", position: 5, column_type: "normal", is_creation_column: false },
        ],
    },
    {
        title: "Standorte",
        ...
        icon: "Factory",
        columns: [
            { title: "Zu erledigen", identifier: "to_do_10_spazi", position: 1, column_type: "normal", is_creation_column: true },
            { title: "Konstruktion", identifier: "progettazione_10_spazi", position: 2, column_type: "normal", is_creation_column: false },
            { title: "Ausführung", identifier: "esecuzione_10_spazi", position: 3, column_type: "normal", is_creation_column: false },
            { title: "Abgeschlossen", identifier: "ultimato_10_spazi", position: 4, column_type: "normal", is_creation_column: false },
        ],
    },
];
...
async function ensureDemoProducts(siteId: string) {
    const categories = [
        { name: "Apparate", color: "#3B82F6" },
        { name: "Kolonnen", color: "#F97316" },
        { name: "Rohrleitungsteile", color: "#8B5CF6" },
        { name: "Tantal-Wärmetauscher", color: "#14B8A6" },
        { name: "Tantal-Heizelemente", color: "#EF4444" },
        { name: "Reemaillierungen", color: "#84CC16" },
    ];
    ...
    const products = [
        { name: "Emaillierter Behälter 6'300 L", type: "Behälter", category: "Apparate", description: "Behälter aus Stahlemail, Volumen 6'300 L", internal_code: "APP-SER-6300" },
        { name: "Emaillierter Behälter 16'000 L", type: "Behälter", category: "Apparate", description: "Behälter aus Stahlemail, Volumen 16'000 L", internal_code: "APP-SER-16000" },
        { name: "Emaillierter Reaktor 25'000 L", type: "Reaktoren", category: "Apparate", description: "Emaillierter Reaktor, max. Volumen 25'000 L", internal_code: "APP-REA-25000" },
        { name: "Emaillierter Abscheider", type: "Abscheider", category: "Apparate", description: "Abscheider aus Stahlemail für chemische Prozesse", internal_code: "APP-SEP-01" },
        { name: "Emaillierte Drucknutsche", type: "Drucknutschen", category: "Apparate", description: "Drucknutsche aus Stahlemail", internal_code: "APP-FIL-01" },
        { name: "Emaillierte Kolonne DN800", type: "Kolonnen", category: "Kolonnen", description: "Emaillierte Kolonnensektion Durchmesser DN800", internal_code: "COL-DN800" },
        { name: "Emaillierte Kolonne DN1200", type: "Kolonnen", category: "Kolonnen", description: "Emaillierte Kolonnensektion Durchmesser DN1200", internal_code: "COL-DN1200" },
        { name: "Emaillierte Kolonne DN2000", type: "Kolonnen", category: "Kolonnen", description: "Emaillierte Kolonnensektion Durchmesser DN2000 (max)", internal_code: "COL-DN2000" },
        { name: "Emailliertes Rohr DN100", type: "Rohre", category: "Rohrleitungsteile", description: "Rohr aus Stahlemail DN100", internal_code: "TUB-DN100" },
        { name: "Rohrverbindung R2", type: "Verbindungen", category: "Rohrleitungsteile", description: "Rohrverbindung R2 mit minimalem Totraum (pharmazeutisch)", internal_code: "TUB-R2" },
        { name: "Emaillierter Bogen 90°", type: "Bögen", category: "Rohrleitungsteile", description: "Bogen aus Stahlemail 90°", internal_code: "TUB-CUR-90" },
        { name: "Emailliertes Ventil", type: "Ventile", category: "Rohrleitungsteile", description: "Ventil aus Stahlemail", internal_code: "TUB-VAL-01" },
        { name: "U-Rohrbündel-Wärmetauscher (lang)", type: "Wärmetauscher", category: "Tantal-Wärmetauscher", description: "U-Rohrbündel-Wärmetauscher aus Tantal, lange Ausführung", internal_code: "TAN-SCA-U-L" },
        { name: "U-Rohrbündel-Wärmetauscher (kurz)", type: "Wärmetauscher", category: "Tantal-Wärmetauscher", description: "U-Rohrbündel-Wärmetauscher aus Tantal, kurze Ausführung", internal_code: "TAN-SCA-U-C" },
        { name: "Vertikaler Heizkörper", type: "Heizelemente", category: "Tantal-Heizelemente", description: "Heizkörper aus Tantal, vertikale Installation", internal_code: "TAN-CAN-V" },
        { name: "Horizontaler Heizkörper", type: "Heizelemente", category: "Tantal-Heizelemente", description: "Heizkörper aus Tantal, horizontale Installation", internal_code: "TAN-CAN-O" },
        { name: "Horizontaler Bajonett-Heizer", type: "Zubehör", category: "Tantal-Heizelemente", description: "Horizontaler Bajonett-Heizer aus Tantal", internal_code: "TAN-BAI-O" },
        { name: "Reemaillierung Apparat", type: "Dienstleistung", category: "Reemaillierungen", description: "Reemaillierung Apparat (ca. 65% des Neupreises)", internal_code: "RIS-APP-01" },
        { name: "Reemaillierung Kolonne", type: "Dienstleistung", category: "Reemaillierungen", description: "Reemaillierung Kolonnensektion", internal_code: "RIS-COL-01" },
    ];
