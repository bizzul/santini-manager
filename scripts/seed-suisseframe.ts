...
const CLIENTS = [
    ...
    { code: "SF-017", businessName: "Progetto 3000", zipCode: 6965, city: "Cadro", address: "Via la Stampa 9" },
    { code: "SF-018", businessName: "Regazzi SA", zipCode: 6596, city: "Gordola", address: "Via alle Gerre 1" },
    { code: "SF-019", businessName: "Rhein Fenster AG", zipCode: 4310, city: "Rheinfelden", address: "" },
    { code: "SF-020", businessName: "Robert Schweizer AG", zipCode: 4057, city: "Basel", address: "Oetlingerstrasse 177" },
    { code: "SF-021", businessName: "Sägesser Fenster AG", zipCode: 4912, city: "Aarwangen", address: "Industriestrasse 26" },
    { code: "SF-022", businessName: "Santini Delbiaggio SA", zipCode: 6512, city: "Giubiasco", address: "Via Mondari 15" },
    { code: "SF-023", businessName: "Scherer AG Pfäffikon", zipCode: 8330, city: "Pfäffikon", address: "Speckstrasse 9" },
    { code: "SF-024", businessName: "Schreinerei Marti AG", zipCode: 3089, city: "Hinterfultigen", address: "" },
    { code: "SF-025", businessName: "Schreinerei Wasem", zipCode: 3153, city: "Rüschegg Gambach", address: "Hirschhorn 301a" },
    { code: "SF-026", businessName: "Spadea SA", zipCode: 6835, city: "Morbio Superiore", address: "Via Lecch 27" },
    { code: "SF-027", businessName: "Steimle Fenster AG", zipCode: 3007, city: "Bern", address: "Rosenweg 38" },
    { code: "SF-028", businessName: "Stich Schreinerei AG", zipCode: 4245, city: "Kleinlützel", address: "Huggerwaldstrasse 227" },
    { code: "SF-029", businessName: "Studio Gendotti SA", zipCode: 6780, city: "Airolo", address: "Via della Stazione 37" },
    { code: "SF-030", businessName: "Suisse Frame", zipCode: 6776, city: "Piotta", address: "Via San Gottardo 114" },
    { code: "SF-031", businessName: "Thöni Fanestras GmbH", zipCode: 7450, city: "Tiefencastel", address: "Via Dalmeras 18" },
    { code: "SF-032", businessName: "Veragouth SA", zipCode: 6930, city: "Bedano", address: "Via Industrie 24" },
    { code: "SF-033", businessName: "Vogel Fensterbauer AG", zipCode: 9403, city: "Goldach", address: "" },
    { code: "SF-034", businessName: "Wenger Fenster AG", zipCode: 3752, city: "Wimmis", address: "Chrümigstrasse 32" },
    { code: "SF-035", businessName: "Winter Schreinerei AG", zipCode: 5082, city: "Kaisten", address: "Kaistenbergstrasse 5" },
    { code: "SF-036", businessName: "Xilema (Veragouth SA)", zipCode: 6930, city: "Bedano", address: "Via Industrie 24" },
];
