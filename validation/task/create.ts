...
export const validation = z.object({
  ...
  data_fatturazione: z.preprocess(parseDate, z.date().optional().nullable()),
  cantiere_contatto: z.string().optional().nullable(),
  cantiere_telefono: z.string().optional().nullable(),
  service_data_inizio: z.preprocess(parseDate, z.date().optional().nullable()),
  service_data_fine: z.preprocess(parseDate, z.date().optional().nullable()),
  ...
  service_ora_inizio: z.preprocess((v) => (v === "" || v == null ? null : v), z.string().regex(/^\d{1,2}:\d{2}(:\d{2})?$/).optional().nullable()),
  service_ora_fine: z.preprocess((v) => (v === "" || v == null ? null : v), z.string().regex(/^\d{1,2}:\d{2}(:\d{2})?$/).optional().nullable()),
  produzione_collaborator_ids: z.array(z.string()).optional().nullable(),
  posa_collaborator_ids: z.array(z.string()).optional().nullable(),
  service_collaborator_ids: z.array(z.string()).optional().nullable(),
