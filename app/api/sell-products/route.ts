...
export async function POST(req: NextRequest) {
    try {
        ...
        const insertData = {
            ...
            diameter_mm: result.data.diameter_mm ?? null,
            length_mm: result.data.length_mm ?? null,
            width_mm: result.data.width_mm ?? null,
            height_mm: result.data.height_mm ?? null,
            depth_mm: result.data.depth_mm ?? null,
            ...
            cod_tipo_cassone: result.data.cod_tipo_cassone || null,
