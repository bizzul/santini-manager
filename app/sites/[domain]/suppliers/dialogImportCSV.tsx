...
const CSV_COLUMNS = [
  {
    name: "ID",
    description: "ID fornitore (per aggiornare record esistenti)",
    required: false,
  },
  { name: "NOME", description: "Nome fornitore", required: true },
  { name: "ABBREVIATO", description: "Nome abbreviato", required: false },
  { name: "DESCRIZIONE", description: "Descrizione", required: false },
  {
    name: "CATEGORIA",
    description: "Categoria fornitore (auto-creata se non esiste)",
    required: false,
  },
  { name: "INDIRIZZO", description: "Indirizzo", required: false },
  { name: "CAP", description: "Codice postale", required: false },
  { name: "LOCALITA", description: "Località/Città", required: false },
  { name: "WEBSITE", description: "Sito web", required: false },
  { name: "EMAIL", description: "Email", required: false },
  { name: "TELEFONO", description: "Telefono", required: false },
  { name: "CONTATTO", description: "Persona di contatto", required: false },
];

// Example row data for the CSV template
const EXAMPLE_ROW = {
  ID: "",
  NOME: "Fornitore Esempio SA",
  ABBREVIATO: "FORN-ES",
  DESCRIZIONE: "Fornitore di materiali edili",
  CATEGORIA: "MATERIALI",
  INDIRIZZO: "Via Industria 10",
  CAP: "6900",
  LOCALITA: "Lugano",
  WEBSITE: "www.fornitore-esempio.ch",
  EMAIL: "info@fornitore-esempio.ch",
...
function DialogImportCSV() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (data.imported > 0 || data.updated > 0) {
        ...
        toast({
          description: `Fornitori: ${messages.join(", ")}!`,
        });
        router.refresh();
      }
    } catch (error: any) {
  ...
  const downloadExampleCSV = () => {
    ...
    link.href = url;
    link.download = "fornitori_template.csv";
  ...
  return (
    ...
    >
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Importa Fornitori da CSV</DialogTitle>
          <DialogDescription>
            Carica un file CSV con i dati dei fornitori. Se il file contiene la
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="skipDuplicates" className="text-sm">
              Salta fornitori duplicati (stesso nome)
            </Label>
          </div>
