...
const CSV_COLUMNS = [
  ...
  {
    name: "CATEGORIA",
    description: "Categoria produttore (auto-creata se non esiste)",
    required: false,
  },
...
const EXAMPLE_ROW = {
  ...
  CAP: "6900",
  LOCALITA: "Lugano",
  WEBSITE: "www.produttore-esempio.ch",
  EMAIL: "info@produttore-esempio.ch",
...
function DialogImportCSV() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/manufacturers/import-csv", {
        method: "POST",
        body: formData,
        headers: {
  ...
  const downloadExampleCSV = () => {
    ...
    link.href = url;
    link.download = "produttori_template.csv";
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="skipDuplicates" className="text-sm">
              Salta produttori duplicati (stesso nome)
            </Label>
          </div>
