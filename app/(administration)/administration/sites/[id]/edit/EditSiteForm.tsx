                ...
                <SiteThemeSettingsModal
                  ...
                  trigger={
                    <Button
                      ...
                      className="border-white/30 text-white hover:bg-white/10"
                    >
                      Gestisci colori e modalita
                    </Button>
                  }
                />
              }
              supportAction={
                <SiteSupportAndSubscriptionModal
                  siteId={site.id}
                  siteName={site.name}
                  siteSubdomain={site.subdomain}
                  initialSupportBotEnabled={initialSupportBotEnabled}
                  canConfigureBot={userRole === "superadmin"}
                  subscription={{
                    status: site.subscription_status || "active",
                    planName: site.subscription_plan || "Professional",
                    renewDate: site.subscription_renew_date || "Non disponibile",
                    seats: Number(site.subscription_seats || 10),
                  }}
                  trigger={
                    <Button
                      variant="outline"
