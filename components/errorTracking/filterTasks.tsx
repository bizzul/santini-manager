      ...
      <Combobox value={selectedTask} onChange={setSelectedTask} name="tasks">
        <div className="relative mt-1">
          ...
          <Transition
            ...
            afterLeave={() => setQuery("")}
          >
            <Combobox.Options className="absolute mt-1 max-h-90  overflow-scroll rounded-md bg-slate-400 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
