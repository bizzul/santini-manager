          ...
          {data &&
            ...
            data.items.map((i: any) => {
              return (
                ...
                >
                  <td className="border-1 p-2 h-14">{i.user.given_name}</td>
                  <td className="border-1 p-2 h-14">{i.error_type}</td>
                  <td className="border-1 p-2 h-14">{i.error_category}</td>
                  <td className="border-1 p-2 h-14">{i.supplier?.name}</td>
                  <td className="border-1 p-2 h-14">{i.position}</td>
