...
export function ProductDocuments({
  ...
  const uploadFile = useCallback(
    async (file: File) => {
      ...
      try {
        ...
        const filePath = `${siteId}/sell-products/${productId}/${fileName}`;
  ...
  const handleDeleteClick = (file: ManagedFile) => {
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  {isImageFile(file.name || "") && file.url ? (
                    <img
                      src={file.url}
                      alt={file.name || "Documento prodotto"}
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Sei sicuro di voler eliminare &quot;{fileToDelete?.name}&quot;? Questa
