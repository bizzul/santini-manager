...
export const EditModal: FC<Props> = ({
  ...
  useEffect(() => {
    if (resource) {
      setValue("productCategoryId", resource.product_category?.id);
      setValue("supplierId", resource.supplierId);
      setValue("name", resource.name);
      setValue("code", resource.code);
      setValue("description", resource.description);
      setValue("unit_price", resource.unit_price);
      setValue("price", resource.price);
      setValue("quantity", resource.quantity);
      setValue("type", resource.type);
      setValue("length", resource.length);
      setValue("width", resource.width);
      setValue("height", resource.height);
    }
  }, [resource]);
  ...
  const onSubmit = (data: any) => {
    ...
    setLoading(true);
    // console.log(data);
    fetch(`/api/products/${resource.id}`, {
      method: "PATCH",
      headers: new Headers({
