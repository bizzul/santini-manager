            ...
            data.items.map((i: any) => {
              return (
                ...
                >
                  ...
                  <td className="border p-2 h-14">{i.category}</td>
                  <td className="border p-2 h-14">{i.address}</td>
                  <td className="border p-2">{i.cap}</td>
                  ...
                  <td className="border p-2">{i.contact}</td>
