      ...
      {data && (
        <div className="mb-2 flex">
          <div className="w-3/4 text-xs pt-4 pl-1">
            {data.pagination?.items_total} Fornitori totali - Pagina {page} di{" "}
            ...
            data.items.map((i: any) => {
              return (
                ...
                >
                  ...
                  <td className="border-1 p-2 h-14">{i.category}</td>
                  <td className="border-1 p-2 h-14">{i.address}</td>
                  <td className="border-1 p-2">{i.cap}</td>
                  <td className="border-1 p-2">{i.location}</td>
                  <td className="border-1 p-2">{i.website}</td>
                  <td className="border-1 p-2">{i.email}</td>
                  <td className="border-1 p-2">{i.phone}</td>
                  <td className="border-1 p-2">{i.contact}</td>
                  <td className="border-1 p-2">
                    <>
                      {i.supplier_image ? (
                        <Image
                          src={`${i.supplier_image}`}
                          alt={i.name}
                          width={50}
                          height={50}
                        />
