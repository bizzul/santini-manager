...
export default function GlobalMarketOverviewCard({
  ...
  return (
    <div className="dashboard-panel space-y-2.5 p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right">
            ...
            <p className="dashboard-panel-subtitle mt-0.5">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-sm font-semibold text-foreground">
            {t("dashboard.activeMarketsTitle")}
          </h4>
        </div>

        {activeMarkets.length === 0 ? (
          <p className="rounded-lg border border-border bg-card/60 px-4 py-2.5 text-center text-sm text-muted-foreground">
            {t("dashboard.activeMarketsEmpty")}
          </p>
        ) : (
          <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 xl:grid-cols-3">
            {activeMarkets.map((market) => (
              <Link
                ...
                className="group flex items-center gap-2 rounded-lg border border-border bg-card/60 px-2.5 py-1.5 transition-colors hover:border-primary/60 hover:bg-card"
              >
                ...
                <span className="shrink-0 text-[11px] text-muted-foreground">
                  ...
                  {formatNumber(market.projects, locale)}{" "}
                  {t("dashboard.projects").toLowerCase()}
                </span>
